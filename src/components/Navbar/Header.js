    ...
    <div className='flex max-w-screen-2xl shadow-lg justify-between text-left mx-auto'>
      <div className='flex items-center font-medium text-3xl py-4'>
            ...
            <div className='flex items-center  '>
              <div className="rounded-full border-[1px] mr-2 border-yellow-200 flex items-center justify-center p-1 h-12 w-12  ">
              <span className='     px-3   '>{ onlineStatus ? <HiStatusOnline className='text-2xl text-green-500'  /> : <HiStatusOffline className='text-2xl text-red-600' />}</span>
              </div>
